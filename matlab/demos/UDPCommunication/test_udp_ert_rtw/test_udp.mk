...
MODEL                   = test_udp
MODULES                 = led.cpp rtGetInf.cpp rtGetNaN.cpp rt_nonfinite.cpp test_udp_data.cpp udp.cpp 
MAKEFILE                = test_udp.mk
MATLAB_ROOT             = /Applications/MATLAB_R2013a.app
ALT_MATLAB_ROOT         = /Applications/MATLAB_R2013a.app
MASTER_ANCHOR_DIR       = 
START_DIR               = /Volumes/HDData/Documents/INSA/5A/Drone/repo/matlab/demos/UDPCommunication
S_FUNCTIONS             = 
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
...
ADD_INCLUDES = \
	...
	-I$(START_DIR) \
	-I/Volumes/HDData/Documents/INSA/5A/Drone/repo/matlab/targets/ardrone/blocks/udp/. \
	-I/Volumes/HDData/Documents/INSA/5A/Drone/repo/matlab/targets/ardrone/blocks/udp \
...
%.o : /Volumes/HDData/Documents/INSA/5A/Drone/repo/matlab/targets/ardrone/blocks/udp/%.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) "$<"
...
%.o : /Volumes/HDData/Documents/INSA/5A/Drone/repo/matlab/targets/ardrone/blocks/udp/%.cpp
	$(CPP) -c $(CPPFLAGS) $(GCC_WALL_FLAG_MAX) "$<"
