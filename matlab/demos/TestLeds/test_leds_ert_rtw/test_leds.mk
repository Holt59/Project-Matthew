...
MODEL                   = test_leds
MODULES                 = led.cpp rtGetInf.cpp rtGetNaN.cpp rt_nonfinite.cpp test_leds_data.cpp 
MAKEFILE                = test_leds.mk
MATLAB_ROOT             = /Applications/MATLAB_R2013a.app
ALT_MATLAB_ROOT         = /Applications/MATLAB_R2013a.app
MASTER_ANCHOR_DIR       = 
START_DIR               = /Volumes/HDData/Documents/INSA/5A/Drone/repo/matlab/demos/TestLeds
S_FUNCTIONS             = 
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
