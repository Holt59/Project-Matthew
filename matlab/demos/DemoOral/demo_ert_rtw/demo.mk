...
MODEL                   = demo
MODULES                 = demo_data.cpp height.cpp led.cpp motor.cpp udp.cpp 
MAKEFILE                = demo.mk
MATLAB_ROOT             = /Applications/MATLAB_R2013a.app
ALT_MATLAB_ROOT         = /Applications/MATLAB_R2013a.app
MASTER_ANCHOR_DIR       = 
START_DIR               = /Volumes/HDData/Documents/INSA/5A/Drone/git/matlab/demos/DemoOral
S_FUNCTIONS             = 
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
...
CPP_ANSI_OPTS    = 
LD               = $(CC)
LDFLAGS          = -static -L"/usr/local/bibrone/lib"
USER_INCLUDES     = -I"/usr/local/bibrone/include"
