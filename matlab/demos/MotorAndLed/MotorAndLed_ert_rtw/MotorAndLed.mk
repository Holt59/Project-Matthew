...
MODEL                   = MotorAndLed
MODULES                 = MotorAndLed_data.cpp height.cpp led.cpp motor.cpp 
MAKEFILE                = MotorAndLed.mk
MATLAB_ROOT             = /Applications/MATLAB_R2013a.app
ALT_MATLAB_ROOT         = /Applications/MATLAB_R2013a.app
MASTER_ANCHOR_DIR       = 
START_DIR               = /Volumes/HDData/Documents/INSA/5A/Drone/repo/matlab/demos/MotorAndLed
S_FUNCTIONS             = 
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 0
...
# Additional includes 
ADD_INCLUDES = \
	-I$(START_DIR)/MotorAndLed_ert_rtw \
	-I$(START_DIR) \
	-I/Volumes/HDData/Documents/INSA/5A/Drone/repo/matlab/targets/ardrone/blocks/height/. \
	-I/Volumes/HDData/Documents/INSA/5A/Drone/repo/matlab/targets/ardrone/blocks/height \
...
%.o : /Volumes/HDData/Documents/INSA/5A/Drone/repo/matlab/targets/ardrone/blocks/height/%.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) "$<"
...
%.o : /Volumes/HDData/Documents/INSA/5A/Drone/repo/matlab/targets/ardrone/blocks/height/%.cpp
	$(CPP) -c $(CPPFLAGS) $(GCC_WALL_FLAG_MAX) "$<"
