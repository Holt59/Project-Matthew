...
ProjDir = '/Volumes/HDData/Documents/INSA/5A/Drone/target';
...
switch (OperatingSystem)
    ...
    case 'macosx'
        arduino.Prefs.setArduinoPath('/Applications/Arduino.app/Contents/Resources');
end

%arduino.Prefs.setBoard('mega'); % For Arduino Mega 1280
arduino.Prefs.setBoard('uno'); % For Arduino Mega 2560
try
