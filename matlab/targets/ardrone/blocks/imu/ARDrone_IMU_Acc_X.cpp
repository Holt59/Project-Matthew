/*
 *   ARDrone_IMU_Acc_X.cpp Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 ...
 *   C++ source code generated on : 18-Dec-2013 14:36:09
 ...
 */
#define S_FUNCTION_NAME                ARDrone_IMU_Acc_X
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
    ...
    if (ssRTWGenIsModelReferenceSimTarget(S)) {
       ...
       */
      ssRegMdlInfo(S, "ARDrone_IMU_Acc_X_wrapper_start", MDL_INFO_ID_RESERVED, 0,
                   0, ssGetPath(S));

      /*
       * Register reserved identifier for OutputFcnSpec for SimulationTarget
       */
      ssRegMdlInfo(S, "ARDrone_IMU_Acc_X_wrapper_output", MDL_INFO_ID_RESERVED,
                   0, 0, ssGetPath(S));
    }
  }
