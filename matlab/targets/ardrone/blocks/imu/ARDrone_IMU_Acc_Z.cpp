/*
 *   ARDrone_IMU_Acc_Z.cpp Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        int16 y1 = IMU_Get_Acceleration_Z()
 *
 *   Simulink version           : 8.2 (R2013b) 08-Aug-2013
 *   C++ source code generated on : 18-Dec-2013 15:30:07
 ...
 */
#define S_FUNCTION_NAME                ARDrone_IMU_Acc_Z
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "IMU_Get_Acceleration_Z", MDL_INFO_ID_RESERVED, 0, 0,
                 ssGetPath(S));
    ...
    if (ssRTWGenIsModelReferenceSimTarget(S)) {
       ...
       */
      ssRegMdlInfo(S, "ARDrone_IMU_Acc_Z_wrapper_start", MDL_INFO_ID_RESERVED, 0,
                   0, ssGetPath(S));

      /*
       * Register reserved identifier for OutputFcnSpec for SimulationTarget
       */
      ssRegMdlInfo(S, "ARDrone_IMU_Acc_Z_wrapper_output", MDL_INFO_ID_RESERVED,
                   0, 0, ssGetPath(S));
    }
  }
