/*
 *   UDP_Send_String.cpp Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        udp_send(int8 u1[], int32 u2)
 *
 *   Simulink version           : 8.1 (R2013a) 13-Feb-2013
 *   C++ source code generated on : 14-Jan-2014 10:51:31
...
/*
   ...
   def.OutputFcnSpec = 'udp_send(int8 u1[], int32 u2)';
 ...
 */
#define S_FUNCTION_NAME                UDP_Send_String
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "udp_send", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    ...
    if (ssRTWGenIsModelReferenceSimTarget(S)) {
       ...
       */
      ssRegMdlInfo(S, "UDP_Send_String_wrapper_start", MDL_INFO_ID_RESERVED, 0,
                   0, ssGetPath(S));

      /*
       * Register reserved identifier for OutputFcnSpec for SimulationTarget
       */
      ssRegMdlInfo(S, "UDP_Send_String_wrapper_output", MDL_INFO_ID_RESERVED, 0,
                   0, ssGetPath(S));

      /*
       * Register reserved identifier for TerminateFcnSpec for SimulationTarget
       */
      ssRegMdlInfo(S, "UDP_Send_String_wrapper_terminate", MDL_INFO_ID_RESERVED,
                   0, 0, ssGetPath(S));
    }
  }
