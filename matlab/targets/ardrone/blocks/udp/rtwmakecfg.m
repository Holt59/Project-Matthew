...
%   MATLAB file generated on : 21-Jan-2014 10:01:40
...
% Dependency info for S-function 'UDP_Receive_Int32'
info(1).SFunctionName = 'UDP_Receive_Int32';
info(1).IncPaths = {'.'};
info(1).SourceFiles = {'udp.cpp'};
info(1).Language = 'C++';
