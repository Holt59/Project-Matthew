/*
 *   UDP_Receive_Int32.cpp Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        int32 y1 = udp_recv_int32(void)
 *
 *   Simulink version           : 8.1 (R2013a) 13-Feb-2013
 *   C++ source code generated on : 14-Jan-2014 11:17:04
 ...
 */
#define S_FUNCTION_NAME                UDP_Receive_Int32
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
    ...
    if (ssRTWGenIsModelReferenceSimTarget(S)) {
       ...
       */
      ssRegMdlInfo(S, "UDP_Receive_Int32_wrapper_start", MDL_INFO_ID_RESERVED, 0,
                   0, ssGetPath(S));

      /*
       * Register reserved identifier for OutputFcnSpec for SimulationTarget
       */
      ssRegMdlInfo(S, "UDP_Receive_Int32_wrapper_output", MDL_INFO_ID_RESERVED,
                   0, 0, ssGetPath(S));

      /*
       * Register reserved identifier for TerminateFcnSpec for SimulationTarget
       */
      ssRegMdlInfo(S, "UDP_Receive_Int32_wrapper_terminate",
