...
%   MATLAB file generated on : 20-Jan-2014 17:46:31
...
% Dependency info for S-function 'ARDrone_Temperature'
info(1).SFunctionName = 'ARDrone_Temperature';
info(1).IncPaths = {'.'};
info(1).SourceFiles = {'baro.cpp'};
info(1).Language = 'C++';
