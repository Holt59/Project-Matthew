/*
 *   ARDrone_Motor.cpp Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        void Motor_Set(single u1, uint8 p1)
 *
 *   Simulink version           : 8.2 (R2013b) 08-Aug-2013
 *   C++ source code generated on : 20-Jan-2014 17:51:03
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "Motor_Initialization", MDL_INFO_ID_RESERVED, 0, 0,
                 ssGetPath(S));
    ...
    if (ssRTWGenIsModelReferenceSimTarget(S)) {
       ...
       */
      ssRegMdlInfo(S, "ARDrone_Motor_wrapper_start", MDL_INFO_ID_RESERVED, 0, 0,
                   ssGetPath(S));

      /*
       * Register reserved identifier for OutputFcnSpec for SimulationTarget
       */
      ssRegMdlInfo(S, "ARDrone_Motor_wrapper_output", MDL_INFO_ID_RESERVED, 0, 0,
                   ssGetPath(S));
    }
  }
