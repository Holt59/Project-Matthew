/*
 *   ARDrone_Acc_Z.cpp Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        single y1 = Accelero_Get_Z()
 *
 *   Simulink version           : 8.2 (R2013b) 08-Aug-2013
 *   C++ source code generated on : 20-Jan-2014 18:25:38
 ...
 */
#define S_FUNCTION_NAME                ARDrone_Acc_Z
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "Accelero_Get_Z", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    ...
    if (ssRTWGenIsModelReferenceSimTarget(S)) {
       ...
       */
      ssRegMdlInfo(S, "ARDrone_Acc_Z_wrapper_start", MDL_INFO_ID_RESERVED, 0, 0,
                   ssGetPath(S));

      /*
       * Register reserved identifier for OutputFcnSpec for SimulationTarget
       */
      ssRegMdlInfo(S, "ARDrone_Acc_Z_wrapper_output", MDL_INFO_ID_RESERVED, 0, 0,
                   ssGetPath(S));
    }
  }
