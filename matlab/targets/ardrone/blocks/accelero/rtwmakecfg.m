...
%   MATLAB file generated on : 16-Jan-2014 23:27:23
...
% Dependency info for S-function 'ARDrone_Acc_Z'
info(1).SFunctionName = 'ARDrone_Acc_Z';
info(1).IncPaths = {'.'};
info(1).SourceFiles = {'accelero.cpp'};
info(1).Language = 'C++';
