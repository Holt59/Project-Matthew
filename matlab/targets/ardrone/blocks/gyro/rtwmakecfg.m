...
%   MATLAB file generated on : 20-Jan-2014 17:47:12
...
% Dependency info for S-function 'ARDrone_Gyro_Z'
info(1).SFunctionName = 'ARDrone_Gyro_Z';
info(1).IncPaths = {'.'};
info(1).SourceFiles = {'gyro.cpp'};
info(1).Language = 'C++';
