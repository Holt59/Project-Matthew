/*
 *   UDPM_Send_Int32.cpp Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        udp_send_int32(int32 u1, int8 p2)
 *
 *   Simulink version           : 8.2 (R2013b) 08-Aug-2013
 *   C++ source code generated on : 22-Jan-2014 20:42:16
 ...
 */
#define S_FUNCTION_NAME                UDPM_Send_Int32
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "udp_emission_init", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

    /*
     * Register reserved identifier for OutputFcnSpec
     */
    ssRegMdlInfo(S, "udp_send_int32", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));

    /*
     * Register reserved identifier for TerminateFcnSpec
     */
    ssRegMdlInfo(S, "udp_emission_terminate", MDL_INFO_ID_RESERVED, 0, 0,
                 ssGetPath(S));
    ...
    if (ssRTWGenIsModelReferenceSimTarget(S)) {
       ...
       */
      ssRegMdlInfo(S, "UDPM_Send_Int32_wrapper_start", MDL_INFO_ID_RESERVED, 0,
                   0, ssGetPath(S));

      /*
       * Register reserved identifier for OutputFcnSpec for SimulationTarget
       */
      ssRegMdlInfo(S, "UDPM_Send_Int32_wrapper_output", MDL_INFO_ID_RESERVED, 0,
                   0, ssGetPath(S));

      /*
       * Register reserved identifier for TerminateFcnSpec for SimulationTarget
       */
      ssRegMdlInfo(S, "UDPM_Send_Int32_wrapper_terminate", MDL_INFO_ID_RESERVED,
                   0, 0, ssGetPath(S));
    }
  }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
   ...
   * Get access to Parameter/Input/Output/DWork/size information
   */
  int8_T *p2 = (int8_T *) ssGetRunTimeParamInfo(S, 1)->data;
  int32_T *u1 = (int32_T *) ssGetInputPortSignal(S, 0);

  /*
   * Call the legacy code function
   */
  udp_send_int32( *u1, *p2);
}
