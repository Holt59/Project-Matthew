...
%   MATLAB file generated on : 22-Jan-2014 22:03:55
...
% Dependency info for S-function 'UDPM_Receive_Int32'
info(1).SFunctionName = 'UDPM_Receive_Int32';
info(1).IncPaths = {'.'};
info(1).SourceFiles = {'udp_multi.cpp'};
info(1).Language = 'C++';
