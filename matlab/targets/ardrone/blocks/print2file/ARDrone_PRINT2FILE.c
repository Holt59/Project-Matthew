/*
 *   ARDrone_PRINT2FILE.c Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 ...
 *   C source code generated on : 16-Dec-2013 17:13:26
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "print2fileInit", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
