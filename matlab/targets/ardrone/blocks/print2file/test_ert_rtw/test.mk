...
MODEL                   = test
MODULES                 = led.cpp motor.cpp rtGetInf.cpp rtGetNaN.cpp rt_nonfinite.cpp test_data.cpp 
MAKEFILE                = test.mk
...
CPP_ANSI_OPTS    = 
LD               = $(CC)
LDFLAGS          = -static -L"/Volumes/HDData/Documents/INSA/5A/Drone/repo/Paparazzi-CPP/lib"
USER_INCLUDES     = -I"/Volumes/HDData/Documents/INSA/5A/Drone/repo/Paparazzi-CPP/include"
...
# Additional includes 
ADD_INCLUDES = \
	-I$(START_DIR)/test_ert_rtw \
	-I$(START_DIR) \
	-I/Volumes/HDData/Documents/INSA/5A/Drone/generation \
