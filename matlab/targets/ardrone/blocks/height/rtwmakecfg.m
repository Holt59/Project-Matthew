...
%   MATLAB file generated on : 20-Jan-2014 17:48:28
...
% Dependency info for S-function 'ARDrone_Height'
info(1).SFunctionName = 'ARDrone_Height';
info(1).IncPaths = {'.'};
info(1).SourceFiles = {'height.cpp'};
info(1).Language = 'C++';
