/*
 *   ARDrone_Height.cpp Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 ...
 *   C++ source code generated on : 20-Jan-2014 17:48:20
 ...
 */
#define S_FUNCTION_NAME                ARDrone_Height
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "Height_Initialization", MDL_INFO_ID_RESERVED, 0, 0,
                 ssGetPath(S));

    /*
     * Register reserved identifier for OutputFcnSpec
     */
    ssRegMdlInfo(S, "Height_Get", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    ...
    if (ssRTWGenIsModelReferenceSimTarget(S)) {
       ...
       */
      ssRegMdlInfo(S, "ARDrone_Height_wrapper_start", MDL_INFO_ID_RESERVED, 0, 0,
                   ssGetPath(S));

      /*
       * Register reserved identifier for OutputFcnSpec for SimulationTarget
       */
      ssRegMdlInfo(S, "ARDrone_Height_wrapper_output", MDL_INFO_ID_RESERVED, 0,
                   0, ssGetPath(S));
    }
  }
