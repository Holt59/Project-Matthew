...
%   MATLAB file generated on : 20-Jan-2014 17:50:40
...
% Dependency info for S-function 'ARDrone_Magneto_Z'
info(1).SFunctionName = 'ARDrone_Magneto_Z';
info(1).IncPaths = {'.'};
info(1).SourceFiles = {'magneto.cpp'};
info(1).Language = 'C++';
