/*
 *   ARDrone_Magneto_Z.cpp Simple C-MEX S-function for function call.
 *
 *   ABSTRACT:
 *     The purpose of this sfunction is to call a simple legacy
 *     function during simulation:
 *
 *        single y1 = Magneto_Get_Z()
 *
 *   Simulink version           : 8.1 (R2013a) 13-Feb-2013
 *   C++ source code generated on : 16-Jan-2014 23:35:06
 ...
 */
#define S_FUNCTION_NAME                ARDrone_Magneto_Z
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
     ...
     */
    ssRegMdlInfo(S, "Magneto_Get_Z", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    ...
    if (ssRTWGenIsModelReferenceSimTarget(S)) {
       ...
       */
      ssRegMdlInfo(S, "ARDrone_Magneto_Z_wrapper_start", MDL_INFO_ID_RESERVED, 0,
                   0, ssGetPath(S));

      /*
       * Register reserved identifier for OutputFcnSpec for SimulationTarget
       */
      ssRegMdlInfo(S, "ARDrone_Magneto_Z_wrapper_output", MDL_INFO_ID_RESERVED,
                   0, 0, ssGetPath(S));
    }
  }
